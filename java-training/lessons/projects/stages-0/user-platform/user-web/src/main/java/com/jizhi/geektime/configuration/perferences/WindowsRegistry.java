...
public final class WindowsRegistry {
     ...
     */
    protected static final WindowsRegistry CURRENT_USER = new WindowsRegistry(USER_ROOT_NATIVE_HANDLE);
    /**
     * Windows注册表<tt>HKEY_LOCAL_MACHINE</tt>单体对象
     */
    protected static final WindowsRegistry LOCAL_MACHINE = new WindowsRegistry(SYSTEM_ROOT_NATIVE_HANDLE);
    /**
...
//    }
    ...
    protected byte[] windowsAbsolutePath(String relativePath) {
        String resolvedPath = StringUtils.replace(relativePath, WindowsRegistry.SLASH, WindowsRegistry.BACK_SLASH);
        resolvedPath = StringUtils.replace(relativePath, WindowsRegistry.BACK_SLASH + WindowsRegistry.BACK_SLASH, WindowsRegistry.BACK_SLASH);
        if (resolvedPath.startsWith(WindowsRegistry.BACK_SLASH)) {
            resolvedPath = StringUtils.substringAfter(resolvedPath, WindowsRegistry.BACK_SLASH);
        }
